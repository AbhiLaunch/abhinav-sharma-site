...
const OUT_PATH = path.join(__dirname, '..', 'og-image-v4.jpg');
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="80" y="365" font-family="Arial, Helvetica, sans-serif" font-size="40" fill="${SOFT}">Berkeley Haas MBA ’28 · Aerospace PhD</text>
