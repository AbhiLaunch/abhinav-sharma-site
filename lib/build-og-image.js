...
const OUT_PATH = path.join(__dirname, '..', 'og-image-v5.jpg');
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="80" y="365" font-family="Arial, Helvetica, sans-serif" font-size="40" fill="${SOFT}">Defense-tech founder</text>
  <text x="80" y="425" font-family="Arial, Helvetica, sans-serif" font-size="32" font-weight="700" fill="${GOLD}">Autonomous systems · Aerospace PhD · Berkeley Haas MBA</text>
