...
const OUT_PATH = path.join(__dirname, '..', 'og-image-v6.jpg');
...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="80" y="455" font-family="Arial, Helvetica, sans-serif" font-size="32" fill="${SOFT}">Aerospace PhD · Berkeley Haas MBA</text>
