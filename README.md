...
- `img/`, `fonts/`, `og-image.jpg`, `apple-touch-icon.png`, `index.html`, `sitemap.xml` — **generated output**. Don't hand-edit these; run the build instead.

## Local development

```bash
npm install
npm run build   # regenerates index.html, img/, fonts/, sitemap.xml, og-image.jpg
